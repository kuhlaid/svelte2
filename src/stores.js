...
export const strApiConfig_Produce = 'ProduceFormConfig';  // name of the produce data configuration 'table' in our indexedDb database
export const strStoreAppSettings = 'AppSettings';  // name of the app configuration 'table' in our indexedDb database
export const strStoreRawApiData = 'RawData';    // pull the raw data requests into the database (testing)
